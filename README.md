...
* **Generative AI & Agents:** LangChain, LangGraph, LangGraph Supervisor/Swarm Architectures, LlamaIndex, Model Context Protocol (MCP), LiveKit.
* **LLM Ops & Safety:** Guardrails AI, NeMo Guardrails, Portkey Gateways, Pydantic Logfire, Ragas, DeepEval, OpenTelemetry.
* **Vector Databases & Storage:** Qdrant, Chroma, Pinecone, PostgreSQL, Neon, Upstash Redis.
* **Backend & Cloud:** Python, FastAPI, Docker, AWS (ECS, Fargate, IAM, Secret Manager), GitHub Actions (CI/CD).

---

### 🛠️ Featured Architecture Highlights
...
<div align="center">
  <i>"Building intelligent systems that are safe, scalable, and production-ready."</i>
</div>
